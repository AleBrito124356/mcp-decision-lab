...
[![PyPI](https://img.shields.io/pypi/v/mcp-decision-lab)](https://pypi.org/project/mcp-decision-lab/)
[![Python](https://img.shields.io/pypi/pyversions/mcp-decision-lab)](https://pypi.org/project/mcp-decision-lab/)
...
```bash
claude mcp add decision-lab -- uvx mcp-decision-lab
```

Prefer a permanent install? `pip install mcp-decision-lab`, then use `mcp-decision-lab` as the command.
...
Tests exercise `mcp_decision_lab/core.py` only and run without the `mcp` package installed. To run the server straight from a source checkout: `python -m mcp_decision_lab.server`.
